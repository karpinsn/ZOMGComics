...
namespace ZOMGComics
{
    /// <summary>
    /// A page that displays a group title, a list of items within the group, and details for the
    /// currently selected item.
    /// </summary>
    public sealed partial class ComicStripPage : ZOMGComics.Common.LayoutAwarePage
    {
        public ComicStripPage()
        {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            else
            {
                ...
                {
                    var selectedItem = ComicDataSource.GetComicStrip((int)pageState["SelectedItem"]);
        ...
        protected override void SaveState(Dictionary<String, Object> pageState)
        {
            if (this.itemsViewSource.View != null)
            {
                var selectedItem = (ComicStrip)this.itemsViewSource.View.CurrentItem;
